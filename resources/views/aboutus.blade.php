  ...
  <div class="row g-0">
    ...
    <div class="col-md-12">
      <div class="card-body">
        ...
        <p>
<h5>1. A member is allowed to keep the book with himself/herself for a period of 20 days, after which the book should be returned.</h5>
<h5>2. A member should pay caution deposit of Rs 300 per order and the amount will be refunded when the book is returned. </h5>
<h5>2. A member should collect the order within 2 day of booking otherwise the order will be cancelled. </h5>
<h5>3. A Penalty of Rs20 per day will be levied from the member for each day the book is kept after the date of return.</h5>
<h5>4. The condition of a book will be inspected and recorded every time it is lent. If there is any damage done to the book at the time of return, the cost of the book will be levied from the member.</h5>
</p>
