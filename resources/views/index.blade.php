...
<br>
	...
	<div class="contact-form">
		...
		<h2>User Login</h2>
			...
			<p>Email</p><input type="text" name="rmailid" placeholder="username"class="form-control">
...
<br>
        <br>
        <a href="/registration">Create an Account</a><br><a href="/adminlogin">Admin Login</a>
        <td><a href="/registration"><button class="btn btn-primary" type="submit" >Create an Account </button></a></td>
